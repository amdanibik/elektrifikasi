                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    <tr>  
                        ...
                        <td><?= $kec->namakabupaten; ?> (<?= $kec->jenis; ?>)</td>
                        <td>
                          <a href="#" class="btn bg-gradient-info btn-sm btn-edit" 
                            data-id="<?= $kec->kecamatanid;?>" 
                            data-nama="<?= $kec->namakecamatan;?>"
                            data-kabid="<?= $kec->kabupaten_id;?>">
                            Ubah
                          </a>
                        </td>
                        <td>
...
<?= $this->include('part/main_foot') ?>
  ...
  <form action="/kecamatan/tambah" method="post">
    ...
    <form action="/kecamatan/ubah" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama Kecamatan</label>
                    <input type="text" class="form-control nama" name="nama" placeholder="Nama Kecamatan">
                </div>
                <div class="form-group">
                    <label>Kabupaten</label>
                    <select name="kabupaten_id" class="form-control kabupaten_id">
                        <option value="">-Pilih-</option>
                        <?php foreach($list_kab as $kab): ?>
                        <option value="<?= $kab->id;?>"><?= $kab->namakabupaten;?>( <?= $kab->jenis;?> )</option>
                        <?php endforeach; ?>
    ...
    <form action="/kecamatan/hapus" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label>Nama Kecamatan</label>
                    <input type="text" class="form-control nama" name="nama" placeholder="Nama Kecamatan" readonly>
                </div>
                <div class="form-group">
                    <label>Kabupaten</label>
                    <select name="kabupaten_id" class="form-control kabupaten_id" readonly>
                        <option value="">-Pilih-</option>
                        <?php foreach($list_kab as $kab): ?>
                        <option value="<?= $kab->id;?>"><?= $kab->namakabupaten;?>( <?= $kab->jenis;?> )</option>
                        <?php endforeach; ?>
